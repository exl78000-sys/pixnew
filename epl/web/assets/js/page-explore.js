...
import { renderKnowledge } from './knowledge-view.js?v=9c821be2';
import { renderAllPlayers } from './allplayers-view.js?v=423ff5fe';
import { renderGame } from './game-view.js?v=b7cc9309';
