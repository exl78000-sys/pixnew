...
import { renderKnowledge } from './knowledge-view.js?v=42dccac9';
import { renderAllPlayers } from './allplayers-view.js?v=faebfad8';
import { renderGame } from './game-view.js?v=5d2df42c';
