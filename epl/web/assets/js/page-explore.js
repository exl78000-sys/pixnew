...
import { renderKnowledge } from './knowledge-view.js?v=7e41e0ae';
import { renderAllPlayers } from './allplayers-view.js?v=4bf55eb0';
import { renderGame } from './game-view.js?v=8be8977c';
