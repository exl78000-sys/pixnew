...
import { renderKnowledge } from './knowledge-view.js?v=8fe92d4d';
import { renderAllPlayers } from './allplayers-view.js?v=daba71f5';
import { renderGame } from './game-view.js?v=3a6e47f5';
