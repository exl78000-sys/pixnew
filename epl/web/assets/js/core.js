...
export const LEAGUES = {
  ...
  es1: { zh: '西甲', brand: '西甲戰情室', en: 'LA LIGA WAR ROOM', open: ['overview', 'index', 'teams', 'players', 'tactics', 'news', 'live', 'model', 'knowledge', 'cups'] },
  ...
  en2: {
    ...
    open: ['overview', 'index', 'teams', 'model', 'news', 'cups'],
