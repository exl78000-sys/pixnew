...
check('本季 20 隊都有 PNG 隊徽(2026-09-26 起是 assets/img/h/ 的圖檔,檔要真的在)', teams.every(t => isImageRef(t.crest, { webDir: join(ROOT, 'web') }, 'png')), String(teams.filter(t => t.crest).length));
