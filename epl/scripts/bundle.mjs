...
const PAGES = ['overview', 'index', 'live', 'fixtures', 'analysis', 'teams', 'tactics', 'players', 'coaches', 'news', 'model', 'knowledge', 'cups', 'ucl', 'ucl-match', 'cup-match', 'allplayers', 'duel', 'explore', 'predict'];
...
async function main() {
  ...
  'knowledge-view', 'allplayers-view', 'game-engine', 'game-playback', 'game-diag', 'game-sim', 'game-view',
