...
const PAGES = ['overview', 'index', 'live', 'fixtures', 'analysis', 'teams', 'tactics', 'players', 'coaches', 'news', 'model', 'knowledge', 'cups', 'intl', 'ucl', 'ucl-match', 'cup-match', 'allplayers', 'duel', 'explore', 'predict'];
...
async function main() {
  ...
  /* 關注球隊(2026-09-14)。`follow` 是儲存層、`follow-view` 是「我的球隊」那個分頁的版面。
     **follow 要排在最前面** —— 賽程表、積分榜、實時戰況、動態、盃賽都 import 它
     (共用模組引用共用模組,照相依排)。 */
  'follow', 'fixture-list', 'sim-table', 'ucl-view', 'predict-core', 'predict-score',
