...
const PAGES = ['overview', 'index', 'live', 'fixtures', 'analysis', 'teams', 'tactics', 'players', 'coaches', 'news', 'model', 'knowledge', 'cups', 'ucl', 'ucl-match', 'allplayers', 'duel', 'explore', 'predict'];
